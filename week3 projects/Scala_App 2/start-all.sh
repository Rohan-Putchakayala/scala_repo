...
# Office Meeting Room Management System - Startup Script
# This script helps you start all required services

set -e

echo "=========================================="
echo "Office Meeting Room Management System - Startup"
echo "=========================================="
echo ""
...
JAVA_VERSION=$(java -version 2>&1 | head -n 1 | cut -d'"' -f2 | sed '/^1\./s
