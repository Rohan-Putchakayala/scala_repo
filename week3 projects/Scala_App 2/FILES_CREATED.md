# Files Created - Office Meeting Room Management System

This document lists all files created for the Office Meeting Room Management System project.
...
### Models (app/models/)
3. **Room.scala** - Room and reservation domain models with JSON serialization
...
6. **ReservationController.scala** - REST API endpoints for room reservations and availability

### Services (app/services/)
7. **ReservationService.scala** - Business logic for room reservation operations
8. **EmailService.scala** - Email notification service
9. **KafkaProducerService.scala** - Kafka message publishing

### Repositories (app/repositories/)
10. **ReservationRepository.scala** - Database operations for rooms and reservations using Slick
