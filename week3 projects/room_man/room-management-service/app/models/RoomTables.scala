...
/**
 * Slick column mappings for Instant and LocalDateTime to SQL Timestamp.
 */
object RoomTime {
...
/** Slick table mapping for `reservations` with FK to `rooms`. */
